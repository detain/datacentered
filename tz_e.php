...
//保留服务器性能测试结果
$valInt = $_POST['pInt'] ?? "No Test";
$valFloat = $_POST['pFloat'] ?? "No Test";
$valIo = $_POST['pIo'] ?? "No Test";
...
function sys_windows()
{
    ...
    //CPU
    $cpuinfo = GetWMI($wmi, "Win32_Processor", ["Name","L2CacheSize","NumberOfCores"]);
    ...
    // SYSINFO
    $sysinfo = GetWMI($wmi, "Win32_OperatingSystem", ['LastBootUpTime','TotalVisibleMemorySize','FreePhysicalMemory','Caption','CSDVersion','SerialNumber','InstallDate']);
